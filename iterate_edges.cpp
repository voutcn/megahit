...
static void InitGlobalData(IterateGlobalData &globals) {
    ...
    globals.output_edge_file = fopen((string(options.output_prefix) + ".edges.0").c_str(), "wb");
    globals.output_read_file = fopen((string(options.output_prefix) + ".rr.pb").c_str(), "wb"); // remaining reads packed binary
